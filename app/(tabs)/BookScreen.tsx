...
const BookScreen: React.FC = () => {
  ...
  const getBooks = async () => {
    try {
      let apiUrl = `https://b353-122-177-101-132.ngrok-free.app/search/books?query=a`;
      if (bookInput !== '' && bookInput !== null) {
        apiUrl = `https://b353-122-177-101-132.ngrok-free.app/search/books?query=${bookInput}`;
      }
